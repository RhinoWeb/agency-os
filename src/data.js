...
// ── CRM: Contacts (people), Companies (orgs), Deals (opportunities) ──
...
export const DEAL_STAGES = [
  { id:'qualified',   label:'Qualified',    probability:20, color:C.muted,   rottingDays:7  },
  { id:'discovery',   label:'Discovery',    probability:40, color:C.accent4, rottingDays:5  },
  { id:'proposal',    label:'Proposal',     probability:60, color:C.accent3, rottingDays:7  },
  { id:'negotiation', label:'Negotiation',  probability:80, color:C.accent2, rottingDays:5  },
  { id:'closed_won',  label:'Closed Won',   probability:100,color:C.accent,  rottingDays:null },
  { id:'closed_lost', label:'Closed Lost',  probability:0,  color:C.red,     rottingDays:null },
];
