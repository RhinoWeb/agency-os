/**
 * Seed data for first-run database initialization.
 * Server-side copy of src/data.js seed values (no JSX/theme imports).
 */
...
export default {
  ...
  clients: [
    ...
    { id:'c7', name:'Maya Wellness', clientType:'creator', status:'active',   mrr:3200,  health:90, contact:'Maya Lin',       email:'maya@mayawellness.co',    since:'Feb 2026', services:['Creator Campaign','Funnel Build'], nextMeeting:'Mon 10AM',    notes:'Top Bali wellness KOL — 180k IG.',
      color:'#EC4899',
      creator: { platform: 'Instagram', niche: 'Wellness / Yoga', followers: '180k', commissionRate: 30, referralLink: 'mayawellness.retreat-kol.com/ref', onboardingStage: 'active', firstSaleDate: '2026-02-14', totalRevenue: 4800 },
    },
  ],
  ...
  campaigns: [
    {
      id: 'camp1', name: 'Q1 SaaS Growth Founders', status: 'active', createdAt: '2026-02-20',
      leadIds: ['l2', 'l4', 'l7'], instantlyCampaignId: null,
      brief: { offer: 'Full-service content + SEO retainer for SaaS companies scaling to $5M ARR', icp: 'B2B SaaS founders and VPs of Marketing with 10-500 employees', tone: 'consultative', caseStudy: 'TechFlow grew organic traffic 240% in 6 months with our content engine' },
      sequence: [
  ...
  contacts: [
    { id:'ct1', name:'Sarah Chen',      email:'sarah@acme.io',          phone:'+1 512-555-0101', title:'VP of Marketing',     companyId:'co1', ownerId:null, tags:['decision-maker','champion'], source:'referral',  avatar:'👩‍💼', notes:'Primary contact, very responsive', interactions:[{id:'i1',date:'2026-03-07',type:'meeting',note:'Q2 strategy kickoff'},{id:'i2',date:'2026-03-01',type:'email',note:'Sent SOW for video production add-on'}] },
    { id:'ct2', name:'James Park',      email:'james@techflow.com',     phone:'+1 415-555-0202', title:'CEO',                 companyId:'co2', ownerId:null, tags:['decision-maker'],              source:'outbound',  avatar:'👨‍💻', notes:'Loves data — always wants metrics', interactions:[{id:'i3',date:'2026-03-06',type:'call',note:'Discussed social ads upsell'},{id:'i4',date:'2026-02-20',type:'email',note:'Sent case study PDF'}] },
    { id:'ct3', name:'Maya Rodriguez',  email:'maya@greenleaf.co',      phone:'+1 305-555-0303', title:'Marketing Director',  companyId:'co3', ownerId:null, tags:['at-risk'],                     source:'website',   avatar:'🌿', notes:'Concerned about organic dip — needs reassurance', interactions:[{id:'i5',date:'2026-03-05',type:'call',note:'Addressed traffic concerns, scheduled deep-dive'}] },
    { id:'ct4', name:'Alex Kim',        email:'alex@quantumlabs.io',    phone:'+1 650-555-0404', title:'Head of Content',     companyId:'co4', ownerId:null, tags:['champion','referral-source'],  source:'referral',  avatar:'🔬', notes:'Very happy, potential referral source', interactions:[{id:'i6',date:'2026-03-08',type:'meeting',note:'Monthly review — all KPIs green'}] },
    { id:'ct5', name:'Ryan Foster',     email:'ryan@novadigital.co',    phone:'+1 646-555-0505', title:'Founder',             companyId:'co5', ownerId:null, tags:['prospect'],                    source:'linkedin',  avatar:'🚀', notes:'Discovery call scheduled, high potential', interactions:[{id:'i7',date:'2026-03-04',type:'email',note:'Sent intro deck + pricing overview'}] },
    { id:'ct6', name:'Leila Torres',    email:'leila@urbanpulse.com',   phone:'+1 323-555-0606', title:'Brand Manager',       companyId:'co6', ownerId:null, tags:['warm-intro'],                  source:'referral',  avatar:'🎨', notes:'Referred by Acme Corp — warm lead', interactions:[{id:'i8',date:'2026-03-03',type:'email',note:'Intro email via Sarah Chen'}] },
    { id:'ct7', name:'David Ortiz',     email:'david@acme.io',          phone:'+1 512-555-0107', title:'Content Lead',        companyId:'co1', ownerId:null, tags:['influencer'],                  source:'referral',  avatar:'📝', notes:'Handles day-to-day content approvals', interactions:[] },
    { id:'ct8', name:'Nina Voss',       email:'nina@apexdigital.de',    phone:'+49 30-555-0808', title:'CEO',                 companyId:'co7', ownerId:null, tags:['prospect','hot'],              source:'outbound',  avatar:'🇩🇪', notes:'Replied asking for pricing — follow up today', interactions:[{id:'i9',date:'2026-03-07',type:'email',note:'Sent pricing sheet + case studies'}] },
  ],

  companies: [
    { id:'co1', name:'Acme Corp',      domain:'acme.io',           industry:'B2B SaaS',      employees:'200-500',  location:'Austin, TX',        website:'https://acme.io',         mrr:12000, status:'client',   health:95, since:'2024-01-15', color:C.accent,  notes:'Q2 video upsell in progress', logo:'🏢' },
    { id:'co2', name:'TechFlow',       domain:'techflow.com',      industry:'SaaS',          employees:'50-200',   location:'San Francisco, CA', website:'https://techflow.com',    mrr:8500,  status:'client',   health:88, since:'2024-03-01', color:C.accent3, notes:'Case study published, exploring social ads', logo:'⚡' },
    { id:'co3', name:'GreenLeaf',      domain:'greenleaf.co',      industry:'Consumer Brand', employees:'50-200',  location:'Miami, FL',         website:'https://greenleaf.co',    mrr:6000,  status:'client',   health:72, since:'2024-06-01', color:C.green,   notes:'At risk — organic traffic concern', logo:'🌿' },
    { id:'co4', name:'Quantum Labs',   domain:'quantumlabs.io',    industry:'AI/SaaS',       employees:'100-500',  location:'Palo Alto, CA',     website:'https://quantumlabs.io',  mrr:9200,  status:'client',   health:91, since:'2024-02-01', color:C.accent4, notes:'Full service — very happy, referral potential', logo:'🔬' },
    { id:'co5', name:'Nova Digital',   domain:'novadigital.co',    industry:'Digital Agency', employees:'20-50',    location:'New York, NY',      website:'https://novadigital.co',  mrr:0,     status:'prospect', health:0,  since:null,         color:C.accent5, notes:'$7k/mo potential', logo:'🚀' },
    { id:'co6', name:'UrbanPulse',     domain:'urbanpulse.com',    industry:'Consumer Brand', employees:'50-200',  location:'Los Angeles, CA',   website:'https://urbanpulse.com',  mrr:0,     status:'prospect', health:0,  since:null,         color:C.yellow,  notes:'Warm lead via Acme referral', logo:'🎯' },
    { id:'co7', name:'Apex Digital',   domain:'apexdigital.de',    industry:'Marketing',     employees:'50-200',   location:'Berlin, DE',        website:'https://apexdigital.de',  mrr:0,     status:'prospect', health:0,  since:null,         color:C.accent2, notes:'EU market — replied asking for pricing', logo:'🇩🇪' },
  ],

  deals: [
    { id:'d1', title:'Acme Corp — Video Production Add-on',  value:2000,  stage:'proposal',    contactId:'ct1', companyId:'co1', createdAt:'2026-02-15', lastActivity:'2026-03-07', expectedClose:'2026-03-20', lostReason:null, notes:'Sarah approved budget, waiting on final sign-off from CFO', tags:['upsell'], pipeline:'default' },
    { id:'d2', title:'TechFlow — Social Ads Management',     value:2500,  stage:'discovery',   contactId:'ct2', companyId:'co2', createdAt:'2026-03-01', lastActivity:'2026-03-06', expectedClose:'2026-03-30', lostReason:null, notes:'James interested, needs demo of ad dashboard', tags:['upsell'], pipeline:'default' },
    { id:'d3', title:'Nova Digital — Content + SEO Retainer', value:7000,  stage:'qualified',   contactId:'ct5', companyId:'co5', createdAt:'2026-03-04', lastActivity:'2026-03-04', expectedClose:'2026-04-01', lostReason:null, notes:'Discovery call scheduled for Wed 3PM', tags:['new-business'], pipeline:'default' },
    { id:'d4', title:'UrbanPulse — Social + Email Package',   value:4500,  stage:'discovery',   contactId:'ct6', companyId:'co6', createdAt:'2026-03-03', lastActivity:'2026-03-03', expectedClose:'2026-04-15', lostReason:null, notes:'Warm intro from Acme — send case studies', tags:['new-business','referral'], pipeline:'default' },
    { id:'d5', title:'Apex Digital — EU Content Partnership', value:5000,  stage:'negotiation', contactId:'ct8', companyId:'co7', createdAt:'2026-02-20', lastActivity:'2026-03-07', expectedClose:'2026-03-15', lostReason:null, notes:'Pricing sent, negotiating scope. Want 6-month commitment.', tags:['new-business','international'], pipeline:'default' },
    { id:'d6', title:'Quantum Labs — Annual Renewal',         value:9200,  stage:'proposal',    contactId:'ct4', companyId:'co4', createdAt:'2026-02-28', lastActivity:'2026-03-08', expectedClose:'2026-03-25', lostReason:null, notes:'Happy client, expecting smooth renewal', tags:['renewal'], pipeline:'default' },
  ],

  emailTemplates: [
    { id:'tpl1', name:'Initial Outreach',      subject:'Quick question about {{company}}', body:'Hi {{firstName}},\n\nI noticed {{company}} is doing great work in {{industry}}. I wanted to reach out because we help companies like yours with content + SEO that drives measurable growth.\n\nWould you be open to a quick 15-min chat this week?\n\nBest,\n{{senderName}}', tags:['outreach','cold'], usageCount:45 },
    { id:'tpl2', name:'Follow-Up After Call',   subject:'Great chatting, {{firstName}}!',   body:'Hi {{firstName}},\n\nGreat speaking with you today. As discussed, here\'s a quick recap:\n\n{{meetingNotes}}\n\nI\'ll send over the proposal by {{proposalDate}}. In the meantime, feel free to reach out with any questions.\n\nBest,\n{{senderName}}', tags:['follow-up'], usageCount:32 },
    { id:'tpl3', name:'Proposal Sent',          subject:'Your custom proposal — {{company}}', body:'Hi {{firstName}},\n\nPlease find attached our proposal for {{company}}. Key highlights:\n\n• Scope: {{services}}\n• Investment: {{dealValue}}/mo\n• Timeline: Start within 2 weeks of sign-off\n\nHappy to walk through this on a call whenever works for you.\n\nBest,\n{{senderName}}', tags:['proposal'], usageCount:18 },
    { id:'tpl4', name:'Check-In (At Risk)',      subject:'Checking in — how are things going?', body:'Hi {{firstName}},\n\nI wanted to check in and make sure everything is going well with our work together. Your feedback is really important to us.\n\nAre there any concerns or areas where you\'d like to see improvements? I\'d love to hop on a quick call this week.\n\nBest,\n{{senderName}}', tags:['retention','at-risk'], usageCount:8 },
    { id:'tpl5', name:'Renewal Reminder',        subject:'Your renewal is coming up — {{company}}', body:'Hi {{firstName}},\n\nJust a heads up — your current agreement with us renews on {{renewalDate}}.\n\nOver the past {{months}} months, here are some highlights:\n\n{{results}}\n\nI\'d love to discuss how we can build on this momentum. Are you available this week for a quick sync?\n\nBest,\n{{senderName}}', tags:['renewal'], usageCount:12 },
  ],
  ...
  notifications: [
    { id:1, text:'Email Outreach completed March promo — 240 emails delivered', type:'success', read:false },
    { id:2, text:'Content Writer finished blog draft — ready for review',        type:'info',    read:false },
    { id:3, text:'SEO Optimizer flagged 3 broken backlinks on /pricing',          type:'warning', read:false },
    { id:4, text:'Lead Nurture workflow triggered for 4 new signups',             type:'info',    read:false },
    { id:5, text:'Data Scraper paused — rate limit on target',                   type:'error',   read:true  },
    { id:6, text:'Weekly report auto-sent to 4 clients',                         type:'success', read:true  },
    { id:7, text:'Acme Corp invoice paid — $12,000',                             type:'success', read:true  },
    { id:8, text:'Blog post series pt.2 hit 1,200 views',                        type:'info',    read:true  },
  ],
